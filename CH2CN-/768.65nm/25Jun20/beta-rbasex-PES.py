...
sz = 2048
imagefile = f'CH2CN-25J1CMb{sz}.txt' 
...
eBE, PES = abel.tools.vmi.toPES(r, I,
                                ...
                                photon_energy=1.0e7/768.65, Vrep=-1000,
                                zoom=zoom)
beta = beta[::-1]
...
ax.plot(wp, pgo*0.8/pgo.max(), lw=1, label='pgo')
ax.plot(wp-24, pgo*0.5/pgo.max(), lw=1, label='pgoDBS')
...
ax.axis(xmin=12000, xmax=13000, ymin=-0.5, ymax=1.1)
